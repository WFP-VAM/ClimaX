...
PATH = f"/mnt/shared/users/wessim.omezzine/ClimaX/Data/Downscaling/Rainfall/{region}/data/"
...
def main(
    ...
    weighted = xr.open_dataset(path_chirps+"weighted_forecast.nc").fillna(0)    
    ...
    ps = glob.glob(PATH + 'rfh_monthly.nc')
